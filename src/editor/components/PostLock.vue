<template>
	...
	>
		<div
			class="znpb-post-lock-modal"
		>
			<div
				class="znpb-post-lock-modal__avatar"
			>
				<img :src="userAvatar" />
			</div>
			<div
				class="znpb-post-lock-modal__content"
			>
				<div
					class="znpb-post-lock-modal__content-text"
				>
					<p
				...
				<div
					class="znpb-post-lock-modal__content-buttons"
				>
					<BaseButton
						type="gray"
					>
