	...
	public static function get_strings() {
		return apply_filters(
			...
			[
				...
				'custom_icons_upgrade_message'           => sprintf( '%s PRO lets you upload your own icons in addition to the Font Awesome icons that everyone is using.', WhiteLabel::get_title() ),
				...
				'regenrate_info'                         => sprintf( '%s Library automatically updates on a daily basis. You can also manually update it by clicking on the sync button.', WhiteLabel::get_title() ),
				'tools_info'                             => sprintf( 'Styles set in %s are saved in CSS files in the uploads folder. Recreate those files, according to the most recent settings.', WhiteLabel::get_title() ),
				...
				// LibraryModal
				'zion_library'                           => sprintf( '%s Library', WhiteLabel::get_title() ),
				...
				'enter_old_and_new_url'                  => sprintf( 'Enter your old and new URLs for your WordPress installation, to update all %s data (Relevant for domain transfers or move to "HTTPS").', WhiteLabel::get_title() ),
				...
				'about_zion_builder'                     => sprintf( 'About %s', WhiteLabel::get_title() ),
				'zion_builder'                           => sprintf( '%s ', WhiteLabel::get_title() ),
				'back_to_wp_dashboard'                   => __( 'Back to WP Dashboard', 'zionbuilder' ),
				'back_to_zion_dashboard'                 => sprintf( '%s  Dashboard', WhiteLabel::get_title() ),
